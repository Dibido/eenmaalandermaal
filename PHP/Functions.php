...
function SearchFunction($SearchKeyword, $SearchPrice, $SearchPaymentMethod, $SearchFilter, $SearchCategory, $SearchSubCategory, $SearchSubSubCategory)
{

$SearchKeyword = cleanInput($SearchKeyword);
$SearchPrice = cleanInput($SearchPrice);
