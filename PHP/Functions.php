      ...
      <tr>
        ...
        <td class="container">
          <div class="content">
            ...
            <span class="preheader">EENMAAL ANDERMAAL VERIFICATIE</span>
            <table class="main">
              ...
              <tr>
                     <tr>
                     <td align="center"  style="background-color: #f6d155">
                     <a href="http://iproject3.icasites.nl/">
                     <img src="http://iproject3.icasites.nl/images/testlogo.png"  alt="EenmaalAndermaal Logo"  height="70" width="auto" style="margin:15px"> 
                     </a>
              </tr>
              </div>
                ...
                <td class="wrapper">
                  ...
                  <table border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <p>Beste gebruiker,</p>
                        <p>U heeft aangegeven zich aan te willen melden op onze website. Dit is uw persoonlijke code: <b> ' . $code . ' </b> </p>
                        ...
                        <p>Vul deze in op de website om de registratieprocedure af te ronden of klik op de activeer knop.</a></p>
                            ...
                            <tr>
                              <td align="left">
                                <table border="0" cellpadding="0" cellspacing="0">
                                  <tbody>
                                    <tr>
                                      <td> <a href="http://iproject3.icasites.nl/registreer1.php?code=' . $urlCode . '" target="_blank">activeren</a> 
                                      </td>
                                    </tr>
                                  </tbody>
                                </table>
            ...
            <div class="footer" style="background-color: #444">
              <table border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td class="content-block" style=" margin-bottom:10px color: #f0f0f0;">
                    <span class="apple-link"><a href="http://iproject3.icasites.nl/">EenmaalAndermaal B.V.</a></span>
                    <br>KVK-nummer: 09091785
                  </td>
                </tr>
                <tr>
                  <td class="content-block powered-by">
                    Powered by Groep 3</a>
                  </td>
                </tr>
              </table>
            </div>
